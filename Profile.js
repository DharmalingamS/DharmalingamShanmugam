...
function onLoadInitialSetUp() {
	...
	let desktopIcon = document.getElementById("Desktop");
	if (screen.availWidth > checkScreenSize) {
...
function screenResized(event) {
	...
	let comapanies = document.getElementsByClassName("professionalExperienceCompanyTap");
  	...
  	if (width <= checkScreenSize && isDesktop == false) {
  		...
  		companyParent.style.position = "relative";
  	} else {
  		...
  		tabParent.style.position = "fixed";
  		companyParent.style.position = "fixed";
  	}
